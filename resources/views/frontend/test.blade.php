...
@section('content')
    <div class="container py-5">
        ...
        <div class="jumbotron">
            ...
            <p><a class="btn btn-primary btn-large" href="#!">Learn more »</a> <a
                    class="btn btn-outline-primary btn-large" href="#!">Learn more »</a></p>
        </div>
        <div class="row">
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                <div class="card mb-4" id="content-formatting">
                    ...
                    <div class="card-body">
                        ...
                        <p><small>This is text in a <code>small</code> wrapper. <abbr title="No Big Deal">NBD</abbr>,
                                right?</small></p>
                        <hr>
                        ...
                        <address class="col-6"><strong>Full Name</strong><br><a href="mailto:#">first.last@example.com</a>
                        </address>
                        <hr>
                        <blockquote>Here's what a blockquote looks like in Bootstrap.<small>Use <code>small</code> to
                                identify the source.</small></blockquote>
                        <hr>
                        <div class="row">
                            <div class="col-xs-6">
                                <ul>
            ...
            <div class="card-body">
                <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle" id="dropdownMenuButton" type="button"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown button</button>
